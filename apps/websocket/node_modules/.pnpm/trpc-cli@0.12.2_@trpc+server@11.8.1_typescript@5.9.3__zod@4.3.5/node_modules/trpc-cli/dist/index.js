...
import { flattenedProperties, incompatiblePropertyPairs, getDescription, getSchemaTypes, getEnumChoices, getAllowedSchemas, } from './json-schema.js';
...
export const z = '@deprecated use `import {z} from "zod/v4"` instead (or use zod/v3 if you need to support use an old version of zod)';
/** @deprecated use `import {z} from "zod/v4"` instead (or use zod/v3 if you need to support use an old version of zod) */
export const zod = '@deprecated use `import {z} from "zod/v4"` instead (or use zod/v3 if you need to support use an old version of zod)';
...
export const parseRouter = ({ router, ...params }) => {
 ...
 */
export function createCli({ router, ...params }) {
...
const parseJson = (value, ErrorClass = InvalidArgumentError, hint = `Malformed JSON.`) => {
    try {
