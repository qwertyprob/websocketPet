    ...
    <Dialog>
      <form>
        <DialogTrigger asChild>
          <Button
            className="w-full rounded-full bg-primary px-8 py-6 font-semibold text-lg text-primary-foreground shadow-lg transition-all duration-200 hover:bg-primary/90 hover:shadow-xl"
            size="lg"
          >
            Report an Issue
          </Button>
